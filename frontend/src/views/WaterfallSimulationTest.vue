  ...
  <div>
    ...
    <div v-if="!isQuizStarted">
      ...
      <div class="form-group">
        ...
        <multiselect v-model="selectedKnowledgePoints" :options="knowledgeOptions" :multiple="true"
          :closeOnSelect="false" placeholder="请选择知识点范围" track-by="name" label="name" :allow-empty="false">
          <!-- 自定义选中项的显示 -->
